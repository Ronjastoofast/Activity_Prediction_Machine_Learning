...
MODEL_PATH = "xgboost_pIC50_model_tuned.joblib"   # from train_and_save_XGBoost_model.py
TOP_N = 20
...
# Plot top N columns excluding ecfp_X columns
...
# export a copy-pasteable feature list for retraining
